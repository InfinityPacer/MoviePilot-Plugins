...
- [ ] **适配跳过站点首次下载提示页**：部分站点存在首次下载种子提示页，新增自动跳过功能。
...
| 刷流站点               | `刷流sites`           | 选择要刷流的站点                           | 若未选择站点但启用了插件，刷流服务不会执行，但刷流检查服务会正常运行                                               |
...
| 开启时间段             | `active_time_range`   | 设置插件刷流和刷流检查的活动时间段         | 示例：00:00-08:00                                                                                                    |
| 站点顺序刷流           | `刷流_sequential`     | 是否按站点顺序刷流                         | 关闭选项时，按站点随机顺序刷流                                                                                       |
