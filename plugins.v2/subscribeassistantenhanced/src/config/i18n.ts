...
const messages: Record<SupportedLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    'preview.disabled.title': '插件未启用', 'preview.disabled.detail': '保存后不会注册订阅助手定时任务',
    'preview.reset.title': '重置数据', 'preview.reset.detail': '保存后会清空插件任务数据并自动复位',
    'preview.backfillNow.title': '立即扫描存量并回填', 'preview.backfillNow.detail': '保存后会扫描存量分集洗版订阅并回填媒体库已有集',
    'preview.general.title': '通用巡检可能运行', 'preview.general.detail': '周期 {value} 分钟',
    'preview.metadata.title': '元数据检查可能运行', 'preview.metadata.detail': '周期 {value} 小时',
    'preview.runOnce.title': '立即运行一次', 'preview.runOnce.detail': '保存后约 3 秒触发一次全量巡检',
    'preview.downloadCheck.title': '下载任务检查可能运行', 'preview.downloadCheck.detail': '周期 {value} 分钟',
    'preview.bestVersion.title': '可能自动创建洗版订阅', 'preview.bestVersion.detail': '普通订阅完成后，符合当前洗版范围的媒体可能自动创建洗版订阅',
    'preview.bestVersionCheck.title': '洗版订阅检查可能运行', 'preview.bestVersionCheck.detail': 'CRON {value}',
    'preview.verify.title': '自动纠错可能运行', 'preview.verify.detail': '周期 {value} 小时',
    'preview.removeTorrent.title': '可能删除下载器任务', 'preview.removeTorrent.detail': '下载停滞、Tracker 关键字或手动删种场景可能触发删种处理',
    'preview.cleanup.title': '可能清理整理记录或文件', 'preview.cleanup.detail': '订阅清理范围已启用，请确认清理场景',
    'preview.pause.title': '可能暂停订阅', 'preview.pause.detail': '无下载策略命中后，电影或剧集订阅可能被暂停',
    'preview.complete.title': '可能完成订阅', 'preview.complete.detail': '无下载策略命中后，电影或剧集订阅可能被标记完成并移除',
    'preview.delete.title': '可能删除订阅', 'preview.delete.detail': '无下载策略命中后，电影或剧集订阅可能被直接删除',
    'preview.episodeToFull.title': '可能从分集洗版转为全集洗版', 'preview.episodeToFull.detail': '订阅目标集满足后，分集洗版可能切换为全集洗版',
    'preview.audit.title': '识别增强可能记录候选风险', 'preview.audit.detail': '审计模式可能记录判定与通知，但不会过滤或移除候选',
    'preview.filter.title': '识别增强可能过滤候选', 'preview.filter.detail': '当前模式和生效的自定义策略覆盖可能过滤或移除候选',
  },
  'zh-TW': {
    ...
    'config.editYaml': '編輯 YAML 策略', 'config.yamlTitle': '識別增強自訂策略',
    ...
    'section.siteProbe': '站點集數探測', 'section.diagnostic': '無進度診斷',
    ...
    'preview.disabled.title': '外掛未啟用', 'preview.disabled.detail': '儲存後不會註冊訂閱助手排程任務',
    'preview.reset.title': '重設資料', 'preview.reset.detail': '儲存後會清除外掛任務資料並自動複位',
    'preview.backfillNow.title': '立即掃描既有並回填', 'preview.backfillNow.detail': '儲存後會掃描既有分集洗版訂閱並回填媒體庫已有集',
    'preview.general.title': '通用巡檢可能執行', 'preview.general.detail': '週期 {value} 分鐘',
    'preview.metadata.title': '元資料檢查可能執行', 'preview.metadata.detail': '週期 {value} 小時',
    'preview.runOnce.title': '立即執行一次', 'preview.runOnce.detail': '儲存後約 3 秒觸發一次全量巡檢',
    'preview.downloadCheck.title': '下載任務檢查可能執行', 'preview.downloadCheck.detail': '週期 {value} 分鐘',
    'preview.bestVersion.title': '可能自動建立洗版訂閱', 'preview.bestVersion.detail': '普通訂閱完成後，符合目前洗版範圍的媒體可能自動建立洗版訂閱',
    'preview.bestVersionCheck.title': '洗版訂閱檢查可能執行', 'preview.bestVersionCheck.detail': 'CRON {value}',
    'preview.verify.title': '自動修正可能執行', 'preview.verify.detail': '週期 {value} 小時',
    'preview.removeTorrent.title': '可能刪除下載器任務', 'preview.removeTorrent.detail': '下載停滯、Tracker 關鍵字或手動刪除種子可能觸發處理',
    'preview.cleanup.title': '可能清理整理記錄或檔案', 'preview.cleanup.detail': '訂閱清理範圍已啟用，請確認清理情境',
    'preview.pause.title': '可能暫停訂閱', 'preview.pause.detail': '無下載策略命中後，電影或影集訂閱可能被暫停',
    'preview.complete.title': '可能完成訂閱', 'preview.complete.detail': '無下載策略命中後，電影或影集訂閱可能被標記完成並移除',
    'preview.delete.title': '可能刪除訂閱', 'preview.delete.detail': '無下載策略命中後，電影或影集訂閱可能被直接刪除',
    'preview.episodeToFull.title': '可能從分集洗版轉為全集洗版', 'preview.episodeToFull.detail': '訂閱目標集符合後，分集洗版可能切換為全集洗版',
    'preview.audit.title': '識別增強可能記錄候選風險', 'preview.audit.detail': '稽核模式可能記錄判定與通知，但不會過濾或移除候選',
    'preview.filter.title': '識別增強可能過濾候選', 'preview.filter.detail': '目前模式和生效的自訂策略可能過濾或移除候選',
  },
  'en-US': {
    ...
    'config.editYaml': 'Edit YAML policy', 'config.yamlTitle': 'Custom recognition policy',
    ...
    'section.siteProbe': 'Site episode probe', 'section.diagnostic': 'Stalled-progress diagnostics',
    ...
    'preview.disabled.title': 'Plugin disabled', 'preview.disabled.detail': 'Saving will not register scheduled assistant tasks',
    'preview.reset.title': 'Reset data', 'preview.reset.detail': 'Saving clears plugin task data and resets this action',
    'preview.backfillNow.title': 'Scan and backfill now', 'preview.backfillNow.detail': 'Saving scans existing episode upgrades and backfills library episodes',
    'preview.general.title': 'General inspection may run', 'preview.general.detail': 'Every {value} minutes',
    'preview.metadata.title': 'Metadata checks may run', 'preview.metadata.detail': 'Every {value} hours',
    'preview.runOnce.title': 'Run once now', 'preview.runOnce.detail': 'Saving starts one full inspection after about 3 seconds',
    'preview.downloadCheck.title': 'Download checks may run', 'preview.downloadCheck.detail': 'Every {value} minutes',
    'preview.bestVersion.title': 'May create best-version subscriptions', 'preview.bestVersion.detail': 'Completed standard subscriptions may create upgrades within the selected scope',
    'preview.bestVersionCheck.title': 'Best-version checks may run', 'preview.bestVersionCheck.detail': 'CRON {value}',
    'preview.verify.title': 'Automatic correction may run', 'preview.verify.detail': 'Every {value} hours',
    'preview.removeTorrent.title': 'May remove download tasks', 'preview.removeTorrent.detail': 'Stalled downloads, Tracker keywords, or manual removals may trigger torrent removal',
    'preview.cleanup.title': 'May remove transfer records or files', 'preview.cleanup.detail': 'Subscription cleanup is enabled; verify the selected scenarios',
    'preview.pause.title': 'May pause subscriptions', 'preview.pause.detail': 'No-download policies may pause movie or TV subscriptions',
    'preview.complete.title': 'May complete subscriptions', 'preview.complete.detail': 'No-download policies may complete and remove movie or TV subscriptions',
    'preview.delete.title': 'May delete subscriptions', 'preview.delete.detail': 'No-download policies may directly delete movie or TV subscriptions',
    'preview.episodeToFull.title': 'May convert episode upgrades to full season', 'preview.episodeToFull.detail': 'Episode upgrades may switch to a full season after reaching the target',
    'preview.audit.title': 'Recognition may record candidate risks', 'preview.audit.detail': 'Audit mode records decisions and notifications without filtering candidates',
    'preview.filter.title': 'Recognition may filter candidates', 'preview.filter.detail': 'The selected mode and active custom policy may filter or remove candidates',
  },
}
