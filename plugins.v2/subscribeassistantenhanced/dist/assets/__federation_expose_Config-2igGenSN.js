...
const {unref:_unref,createElementVNode:_createElementVNode,createTextVNode:_createTextVNode,resolveComponent:_resolveComponent,withCtx:_withCtx,createVNode:_createVNode,toDisplayString:_toDisplayString,renderList:_renderList,Fragment:_Fragment,openBlock:_openBlock,createElementBlock:_createElementBlock,createSlots:_createSlots,createBlock:_createBlock,createCommentVNode:_createCommentVNode,normalizeClass:_normalizeClass,withModifiers:_withModifiers} = await importShared('vue');

const _hoisted_1 = { class: "sae-config-header" };
const _hoisted_2 = { class: "sae-config-header__brand" };
const _hoisted_3 = ["src"];
const _hoisted_4 = { class: "sae-config-header__identity" };
const _hoisted_5 = { class: "sae-config-header__status" };
const _hoisted_6 = { class: "sae-config-header__actions" };
const _hoisted_7 = { class: "sae-config-layout" };
const _hoisted_8 = { class: "sae-mobile-group-selector" };
const _hoisted_9 = {
  class: "sae-group-nav",
  "aria-label": "配置分组"
};
const _hoisted_10 = { class: "sae-field-surface" };
const _hoisted_11 = { class: "sae-field-surface__heading" };
const _hoisted_12 = { class: "sae-field-surface__heading-copy" };
const _hoisted_13 = { class: "sae-field-panel__title-actions" };
const _hoisted_14 = { class: "sae-field-control" };
const _hoisted_15 = {
  key: 0,
  class: "sae-tracker-entry"
};
const _hoisted_16 = { class: "sae-tracker-entry__copy" };
const _hoisted_17 = { class: "sae-impact-preview" };
const _hoisted_18 = { class: "sae-impact-preview__title" };
const _hoisted_19 = { class: "sae-impact-preview__group" };
const _hoisted_20 = { class: "sae-impact-preview__list" };
const _hoisted_21 = {
  "aria-label": "运行概况",
  class: "sae-runtime-summary"
};
const _hoisted_22 = { class: "sae-runtime-summary__title" };
const _hoisted_23 = {
  key: 0,
  class: "sae-runtime-summary__state"
};
const _hoisted_24 = { class: "sae-runtime-summary__metrics" };
const _hoisted_25 = { class: "sae-runtime-summary__row" };
const _hoisted_26 = { class: "sae-runtime-summary__row" };
const _hoisted_27 = { class: "sae-runtime-summary__domains" };
const _hoisted_28 = {
  key: 2,
  class: "sae-runtime-summary__unavailable"
};
const _hoisted_29 = { class: "sae-mobile-savebar" };
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const expandedAdvancedKeys = ref([]);
    ...
    const expandedPanelKeys = computed({
      get: () => [...coreFieldKeys.value, ...expandedAdvancedKeys.value],
      set: (keys) => {
        const allowedKeys = new Set(collapsibleFieldKeys.value);
        expandedAdvancedKeys.value = keys.filter((key) => typeof key === "string").filter((key) => allowedKeys.has(key));
      }
    });
    watch(
        ...
        _createElementVNode("form", {
          ...
          _createElementVNode("header", _hoisted_1, [
            _createElementVNode("div", _hoisted_2, [
              ...
              _createElementVNode("div", _hoisted_4, [
                _cache[9] || (_cache[9] = _createElementVNode("h1", { class: "sae-config-header__title" }, "订阅助手（增强版）", -1)),
                _createElementVNode("div", _hoisted_5, [
                  ...
                  _createVNode(_component_VChip, {
                    color: draft.enabled ? "success" : void 0,
                    size: "x-small",
                    variant: "tonal"
                  }, {
                    default: _withCtx(() => [
                      _createTextVNode(_toDisplayString(draft.enabled ? "已启用" : "未启用"), 1)
                    ]),
                    _: 1
                  }, 8, ["color"])
                ])
          ...
          _createVNode(_component_VAlert, {
            ...
            default: _withCtx(() => [..._cache[10] || (_cache[10] = [
              _createTextVNode(" BETA 版本提示：本插件仍处于测试阶段，可能调整订阅状态、洗版记录、下载任务和媒体文件。 ", -1)
            ])]),
            _: 1
          }),
          _createElementVNode("div", _hoisted_7, [
            ...
            _createElementVNode("main", _hoisted_10, [
              _createElementVNode("div", _hoisted_11, [
                ...
                activeGroupMeta.value.highRisk ? (_openBlock(), _createBlock(_component_VChip, {
                  key: 0,
                  color: "error",
                  size: "small",
                  variant: "tonal"
                  ...
                  default: _withCtx(() => [..._cache[11] || (_cache[11] = [
                    _createTextVNode(" 高风险 ", -1)
                  ])]),
                  _: 1
                })) : _createCommentVNode("", true)
              ]),
              _createVNode(_component_VExpansionPanels, {
                modelValue: expandedPanelKeys.value,
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => expandedPanelKeys.value = $event),
                class: "sae-field-panels",
                multiple: "",
                variant: "accordion"
              }, {
                default: _withCtx(() => [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(activeFields.value, (field) => {
                    return _openBlock(), _createBlock(_component_VExpansionPanel, {
                      ...
                      class: _normalizeClass([
                        ...
                        "app-surface-flat",
                        "app-surface-square",
                        isCollapsibleField(field) ? "sae-field-panel--collapsible" : "sae-field-panel--core"
                      ]),
                      value: field.key
                    }, {
                      default: _withCtx(() => [
                        isCollapsibleField(field) ? (_openBlock(), _createBlock(_component_VExpansionPanelTitle, {
                          key: 0,
                          class: "sae-field-panel__title"
                        }, {
                          actions: _withCtx(({ expanded }) => [
                            _createElementVNode("div", _hoisted_13, [
                              field.risk === "danger" ? (_openBlock(), _createBlock(_component_VChip, {
                                key: 0,
                                color: "error",
                                size: "x-small",
                                variant: "tonal"
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_14, [
                              field.kind === "switch" ? (_openBlock(), _createBlock(_component_VSwitch, {
                                ...
                                "onUpdate:modelValue": ($event) => draft[field.key] = $event,
                                "aria-label": field.label,
                                color: fieldColor(field),
                                hint: field.hint,
                                label: isCollapsibleField(field) ? void 0 : field.label,
                                "persistent-hint": ""
                              }, null, 8, ["modelValue", "onUpdate:modelValue", "aria-label", "color", "hint", "label"])) : field.kind === "select" ? (_openBlock(), _createBlock(_component_VSelect, {
                                key: 1,
                                modelValue: draft[field.key],
                                "onUpdate:modelValue": ($event) => draft[field.key] = $event,
                                "aria-label": field.label,
                                ...
                                "item-value": "value",
                                "persistent-hint": ""
                              }, null, 8, ["modelValue", "onUpdate:modelValue", "aria-label", "color", "hint", "items", "label"])) : field.kind === "multi-select" ? (_openBlock(), _createBlock(_component_VSelect, {
                                key: 2,
                                modelValue: draft[field.key],
                                "onUpdate:modelValue": ($event) => draft[field.key] = $event,
                                "aria-label": field.label,
                                ...
                                multiple: "",
                                "persistent-hint": ""
                              }, null, 8, ["modelValue", "onUpdate:modelValue", "aria-label", "color", "hint", "items", "label"])) : field.kind === "number" ? (_openBlock(), _createBlock(_component_VTextField, {
                                key: 3,
                                "aria-label": field.label,
                                color: fieldColor(field),
                                hint: field.hint,
                              ...
                              }, null, 8, ["aria-label", "color", "hint", "label", "model-value", "onUpdate:modelValue"])) : field.kind === "text" || field.kind === "cron" ? (_openBlock(), _createBlock(_component_VTextField, {
                                key: 4,
                                modelValue: draft[field.key],
                                "onUpdate:modelValue": ($event) => draft[field.key] = $event,
                                "aria-label": field.label,
                                ...
                                label: isCollapsibleField(field) ? void 0 : field.label,
                                "persistent-hint": ""
                              }, null, 8, ["modelValue", "onUpdate:modelValue", "aria-label", "color", "hint", "label"])) : field.kind === "textarea" ? (_openBlock(), _createBlock(_component_VTextarea, {
                                key: 5,
                                modelValue: draft[field.key],
                                "onUpdate:modelValue": ($event) => draft[field.key] = $event,
                                "aria-label": field.label,
                                ...
                                label: isCollapsibleField(field) ? void 0 : field.label,
                                "persistent-hint": ""
                              }, null, 8, ["modelValue", "onUpdate:modelValue", "aria-label", "color", "hint", "label"])) : _createCommentVNode("", true)
                            ])
                          ]),
                          _: 2
                        }, 1024)
              ...
              activeGroup.value === "cleanup" ? (_openBlock(), _createElementBlock("div", _hoisted_15, [
                ...
                _createVNode(_component_VBtn, {
                  ...
                  default: _withCtx(() => [
                    _createTextVNode(" 编辑" + _toDisplayString(_unref(trackerField).label), 1)
                  ]),
                  _: 1
                }, 8, ["aria-label"])
              ])) : _createCommentVNode("", true)
            ...
            _createElementVNode("aside", _hoisted_17, [
              _createElementVNode("div", _hoisted_18, [
                ...
                _cache[13] || (_cache[13] = _createElementVNode("h2", null, "配置影响预览", -1))
              ]),
              ...
              _createElementVNode("section", _hoisted_21, [
                _createElementVNode("div", _hoisted_22, [
                  ...
                  _cache[14] || (_cache[14] = _createElementVNode("h3", null, "运行概况", -1))
                ]),
                summaryState.value === "loading" ? (_openBlock(), _createElementBlock("div", _hoisted_23, [
                  ...
                  _cache[15] || (_cache[15] = _createElementVNode("span", null, "正在读取运行概况", -1))
                  ...
                  _createElementVNode("div", _hoisted_24, [
                    _createElementVNode("div", _hoisted_25, [
                      ...
                      _cache[16] || (_cache[16] = _createElementVNode("span", null, "待定订阅", -1)),
                    ...
                    _createElementVNode("div", _hoisted_26, [
                      ...
                      _cache[17] || (_cache[17] = _createElementVNode("span", null, "监控下载任务", -1)),
                ...
                ], 64)) : (_openBlock(), _createElementBlock("p", _hoisted_28, "运行概况暂不可用"))
              ])
            ])
          ]),
                ...
                _createVNode(_component_VCardText, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VTextarea, {
                      modelValue: draft.default_tracker_response,
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => draft.default_tracker_response = $event),
