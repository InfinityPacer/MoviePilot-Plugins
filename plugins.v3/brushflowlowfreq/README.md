...
**本文档适用于 MoviePilot V3 专用实现；旧实现文档见 [V2 插件](../../plugins.v2/brushflowlowfreq/README.md)。**

## 版本更新日志

- v4.8
  - 修复种子标题或描述为空时，包含/排除规则触发异常的问题

- v4.7
  - 使用公开站点与订阅查询 SDK，完善订阅排除的分页读取与媒体身份匹配

- v4.6
  - 适配 V3 SDK 导入规范，迁移至 app.sdk 体系

- v4.5
  - MoviePilot V3 版本站点刷流（低频版）插件
