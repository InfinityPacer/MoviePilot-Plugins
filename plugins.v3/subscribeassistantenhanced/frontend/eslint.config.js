...
const browserFiles = [
  'plugins.v3/subscribeassistantenhanced/frontend/src/**/*.{js,mjs,cjs,jsx,ts,tsx,mts,cts,vue}',
  'tests/v3/subscribeassistantenhanced/frontend/**/*.{js,mjs,cjs,jsx,ts,tsx,mts,cts,vue}',
]
const nodeFiles = ['plugins.v3/subscribeassistantenhanced/frontend/*.config.{js,mjs,cjs,ts,mts,cts}']
