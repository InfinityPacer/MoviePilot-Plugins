...
from ..shared.subscribe import format_subscribe, is_full_best_version_subscribe, subscribe_tmdb_id
...
class SubscribeLifecycleCoordinator:
    ...
    def handle_subscribe_added(self, subscribe, mediainfo=None, episodes=None) -> LifecycleResult:
        ...
        if episodes is None and is_tv_media and self._tmdb_episodes and tmdb_id is not None:
    ...
    def handle_library_updated(self, subscribe_id: int | None = None, reason: str = "") -> LifecycleResult:
        ...
        episodes = []
        tmdb_id = subscribe_tmdb_id(subscribe)
        if self._tmdb_episodes and tmdb_id is not None:
