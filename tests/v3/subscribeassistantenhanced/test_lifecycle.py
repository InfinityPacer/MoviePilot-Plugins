...
def test_pending_from_judge_schedules_search_before_pending_for_new_subscribe(fake_lifecycle):
    subscribe = SimpleNamespace(id=1, state="N", media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_subscribe_added_pre_air_stops_before_pending(fake_lifecycle):
    subscribe = SimpleNamespace(id=11, state="N", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_subscribe_added_pending_for_new_state_schedules_search_once(fake_lifecycle):
    subscribe = SimpleNamespace(id=12, state="N", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
    fake_lifecycle.pending_judge.should_enter_pending.return_value = (True, "开播日期未知")
...
def test_subscribe_added_uses_episode_group_scope(fake_lifecycle):
    subscribe = SimpleNamespace(id=13, state="R", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group="eg-1")
...
def test_subscribe_added_non_tv_skips_tv_pending_flow(fake_lifecycle):
    subscribe = SimpleNamespace(id=14, state="R", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_subscribe_added_new_subscription_skips_airing_gap_when_not_pending(fake_lifecycle):
    subscribe = SimpleNamespace(id=15, state="N", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
    fake_lifecycle.pending_judge.should_enter_pending.return_value = (False, "")
...
def test_subscribe_added_running_subscription_pauses_after_library_update(fake_lifecycle):
    subscribe = SimpleNamespace(id=16, state="R", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
    fake_lifecycle.pending_judge.should_enter_pending.return_value = (False, "")
...
def test_meta_check_refreshes_same_pause_silently(fake_lifecycle):
    subscribe = SimpleNamespace(id=20, state="S", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_meta_check_reports_p_when_pending_exit_leaves_another_source(fake_lifecycle):
    ...
    subscribe = SimpleNamespace(id=25, state="P", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_subscribe_added_full_best_version_stops_before_pending(fake_lifecycle):
    subscribe = SimpleNamespace(id=17, state="R", best_version=True, best_version_full=True, type="电视剧",
                                media_source="themoviedb", media_id="100", season=1, episode_group=None)
...
def test_library_updated_checks_airing_gap_only_for_active_tv(fake_lifecycle):
    subscribe = SimpleNamespace(id=32, state="R", best_version=False, media_source="themoviedb", media_id="100", season=1, episode_group=None)
