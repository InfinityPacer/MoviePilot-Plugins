...
class TestMatchSubscribe:
    ...
    def test_match(self):
        sub = SimpleNamespace(id=1, name="测试", media_source="themoviedb", media_id="100",
                              season=1, episode_group=None)
        task = {"id": 1, "name": "测试", "media_source": "themoviedb", "media_id": "100", "season": 1}
        assert match_subscribe(sub, task) is True

    def test_mismatch_id(self):
        sub = SimpleNamespace(id=1, name="测试", media_source="themoviedb", media_id="100",
                              season=1, episode_group=None)
        task = {"id": 2, "name": "测试", "media_source": "themoviedb", "media_id": "100", "season": 1}
...
class TestSubscribeIdentity:
    ...
    def test_identity_matches_current_subscribe(self):
        ...
        subscribe = SimpleNamespace(
            id=1, media_source="themoviedb", media_id="100", season=1, episode_group="eg-1",
        )
