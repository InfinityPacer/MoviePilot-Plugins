...
def test_candidate_summary_redacts_cookie_and_local_paths():
    torrent = SimpleNamespace(
        enclosure="",
        page_url="",
        title="资源 Cookie: uid=SECRET /Users/example/Downloads/private.torrent",
...
def test_candidate_summary_redacts_unicode_local_paths():
    torrent = SimpleNamespace(
        enclosure="",
        page_url="",
        title="资源 /Users/example/Library/CloudStorage/ExampleDrive/媒体库/剧集/测试剧.mkv",
    ...
    assert "ExampleDrive" not in summary
...
def test_keyword_reason_is_sanitized_in_audit_and_notification():
    ...
    context = SimpleNamespace(
        torrent_info=SimpleNamespace(
            ...
            description="候选说明 /Users/example/private/file.torrent",
            site_name="站点A",
            category="TV",
        ),
